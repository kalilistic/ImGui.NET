...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        public static bool CollapsingHeader(string label, ref bool p_visible, int flags)
        {
            ...
            byte native_p_visible_val = p_visible ? (byte)1 : (byte)0;
            byte* native_p_visible = &native_p_visible_val;
            byte ret = ImGuiNative.igCollapsingHeaderBoolPtr(native_label, native_p_visible, (ImGuiTreeNodeFlags)flags);
            if (label_byteCount > Util.StackAllocationSizeLimit)
            {
                Util.Free(native_label);
            }
        ...
        [Obsolete("Use method with non-primitive (enum) arguments instead.")]
        public static void DockSpace(uint id, Vector2 size, int flags)
        {
            ImGuiWindowClass* window_class = null;
            ImGuiNative.igDockSpace(id, size, (ImGuiDockNodeFlags)flags, window_class);
        }
        ...
        [Obsolete("Use method with non-primitive (enum) arguments instead.")]
        public static void DockSpace(uint id, Vector2 size, int flags, ImGuiWindowClassPtr window_class)
        {
            ImGuiWindowClass* native_window_class = window_class.NativePtr;
            ImGuiNative.igDockSpace(id, size, (ImGuiDockNodeFlags)flags, native_window_class);
        }
